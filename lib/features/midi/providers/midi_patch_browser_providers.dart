...
final Provider<MidiPatchFavoriteDao> midiPatchFavoriteDaoProvider = Provider<MidiPatchFavoriteDao>(
  (ref) => MidiPatchFavoriteDao(ref.watch(appDatabaseProvider)),
);

final Provider<MidiPatchRecentDao> midiPatchRecentDaoProvider = Provider<MidiPatchRecentDao>(
  (ref) => MidiPatchRecentDao(ref.watch(appDatabaseProvider)),
);

final Provider<MidiPatchFavoriteRepository> midiPatchFavoriteRepositoryProvider =
    Provider<MidiPatchFavoriteRepository>(
...
final StreamProvider<Set<int>> favoritePatchIdsProvider = StreamProvider<Set<int>>(
  (ref) => ref.watch(midiPatchFavoriteRepositoryProvider).watchFavoritePatchIds(),
);

final StreamProvider<List<MidiPatchRecent>> patchRecentsProvider = StreamProvider<List<MidiPatchRecent>>(
