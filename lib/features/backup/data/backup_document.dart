...
String encodeVaultBackup(VaultRows rows, {required DateTime exportedAt}) {
  final document = <String, dynamic>{
    ...
    'tables': {
      ...
      'signalBlocks': _encode(rows.signalBlocks),
      'signalConnections': _encode(rows.signalConnections),
      'signalEndpoints': _encode(rows.signalEndpoints),
...
VaultRows _rows(Map<String, dynamic> tables) => (
  ...
  signalBlocks: _decode(tables, 'signalBlocks', SignalBlock.fromJson),
  signalConnections: _decode(
    tables,
    'signalConnections',
    SignalConnection.fromJson,
  ),
  signalEndpoints: _decode(tables, 'signalEndpoints', SignalEndpoint.fromJson),
