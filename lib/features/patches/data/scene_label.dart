/// The most a stored label can be, which is what both
/// `change_logs.configuration_name` and `rig_snapshot_entries.configuration_name`
/// hold.
...
/// together.
///
/// Two patches on one unit may each have a "Verse", and both the history and a
/// snapshot are read a unit at a time, so a scene's own name would not say which
/// sound it was.
///
...
/// is a snapshot the app declines to take over a label.
String sceneLabel(
  String patchName,
  String sceneName, {
